...
const Publicacion = () => {
    ...
    if (!publicacion || Object.keys(publicacion).length === 0 && !error) return 'Cargando...';

    const { nombre, comentarios, creado, descripcion, empresa, url, urlimagen, votos, creador, haVotado } = publicacion;
                ...
                `}> {nombre} </h1>
                        ...
                        <ContenedorPublicacion>
                            <div>
                                ...
                                <p>Por {creador.nombre} ° Servicio de {empresa}</p>
                                <img src={urlimagen} />
                                <p>{descripcion}</p>
